  ...
  return (
    <div className="space-y-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 bg-zinc-950 border border-zinc-800 rounded-lg text-xs text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-zinc-600 font-mono"
              />
            </div>
            <div>
              <label className="block text-[11px] font-mono text-zinc-400 mb-1">
          ...
          <div className="flex justify-end gap-2 pt-1">
            ...
            <button
              ...
              className="px-3 py-1 rounded bg-zinc-800 hover:bg-zinc-700 text-xs font-medium text-zinc-100 disabled:opacity-50"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          {workspaces.length > 5 && (
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 bg-zinc-950 border border-zinc-800 rounded-lg text-xs text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-zinc-700 font-mono"
              />
            </div>
          )}
        ...
        <div className="lg:col-span-8 bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex flex-col space-y-4 min-h-[480px]">
          {selectedWorkspace ? (
            <>
              <div className="border-b border-zinc-800 pb-3 flex items-center justify-between">
                ...
                {treeData && (
                  <span className="text-[11px] font-mono text-zinc-400 bg-zinc-950 px-2 py-1 rounded border border-zinc-800 shrink-0">
                    {treeData.total_entries} entries
                  </span>
                )}
              </div>

              {/* Directory Tree / Tree-Scoped State */}
              <div className="flex-1 overflow-y-auto max-h-[420px] pr-2">
                {isLoadingTree ? (
                  ...
                  <div className="p-8 text-center space-y-2.5 bg-zinc-950/50 rounded-xl border border-zinc-800 my-4">
                    ...
                    <p className="text-[11px] text-zinc-400 max-w-sm mx-auto">
                      ...
                      (likely a temporary test runner workspace). Register or
              ...
              {selectedNode && (
                <div className="border-t border-zinc-800 pt-3 bg-zinc-950/60 p-3 rounded-lg space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-mono text-zinc-300 font-medium truncate">
                      {selectedNode.path}
                    </span>
                  ...
                  {selectedNode.type === "file" && (
                    <div className="text-[11px] text-zinc-500 italic">
                      File content viewing is not available yet.
                    </div>
                  )}
                </div>
              )}
